...
<section className="mt-10 space-y-8 border-t pt-10 text-muted-foreground leading-8">
  ...
  <p>
    ...
    Your documents remain private because files are not permanently stored
    after processing.
  </p>
  ...
  <p>
    Yes. You can separate a single page or every page from your PDF depending
    on your needs.
  </p>
  ...
  <p>
    Yes. Your documents are processed locally whenever possible and are not
